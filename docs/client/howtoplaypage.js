...
<div class="row" id="tutorial">
    <table class="table table-striped">
        <tbody>
            <tr id="dragndrop">
                <td>
                    <img src="./assets/tutorials/drag.gif" class="tutorialgif"alt="drag and drop">
                </td>
                <td>
            ...
            <tr id="portals1">
                <td>
                    <p> The core mechanics of the game are the portals.<br>
                        You can place a <b>Portal</b> via clicking on a <b>gray wall</b> with the left or right
                        mouse button </p>
                </td>
                <td>
                    <img src="./assets/tutorials/portals.gif" class="tutorialgif"alt="portals">
                </td>
            </tr>
            <tr id="portals2">
                <td>
                    <img src="./assets/tutorials/portals2.gif" class="tutorialgif"alt="portals2">
                </td>
                <td>
            ...
            <tr id="goal">
                ...
                <td>
                    <img src="./assets/tutorials/goal.gif" class="tutorialgif"alt="goal">
                </td>
            </tr>
            <tr id="unreachable">
                <td>
                    <img src="./assets/tutorials/unreachable.gif" class="tutorialgif"alt="unreachable">
                </td>
                <td>
    ...
    <table class="table table-striped">
        <tbody>
            <tr id="momentum">
                ...
                <td>
                    <img src="./assets/tutorials/velocity.gif" class="tutorialgif" alt="momentum">
                </td>
            </tr>
            <tr id="gravity">
                <td>
                    <img src="./assets/tutorials/gravity.gif" class="tutorialgif" alt="gravity">
                </td>
                <td>
                    <p><b>Think</b> out of the box!<br> Use the portals to <b>reach</b> otherwise <b>unreachable</b>
                        places</p>
                </td>
            </tr>
        </tbody>
