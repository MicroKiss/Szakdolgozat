...
class mapLoader {
    ...
    setMap()  //you can switch between gamerooms with this function
    {
        ...
        palya = [
            ...
            [W, W, W, W, W, W, W, W, W, W, W, W, W, W, W, W, W],
            [W, W, _, _, _, _, W, _, _, _, _, _, W, _, _, W, W],
            [W, W, _, _, B, _, W, _, _, _, B, _, W, _, _, W, W],
            [W, W, _, _, _, _, W, _, _, _, _, _, W, _, _, W, W],
            [W, W, _, _, _, _, W, _, _, _, _, _, W, _, _, W, W],
            [W, W, W, W, W, W, W, _, _, _, _, _, W, _, _, W, W],
            [W, W, _, _, _, _, _, W, W, W, W, W, W, _, _, W, W],
            [W, W, _, _, _, _, _, _, _, _, _, _, _, _, _, W, W],
            [W, W, _, _, _, _, _, _, _, _, _, _, _, _, _, W, W],
            [W, W, _, _, _, _, _, _, _, _, _, _, _, _, _, W, W],
            [W, W, _, _, _, _, _, _, _, _, _, _, _, _, _, W, W],
            [W, W, W, W, W, W, W, W, W, W, W, W, W, W, W, W, W],
